  ...
  <div className={s.container}>
    <div className={s.banner} style={{ backgroundImage: `url(${banner})` }}>
      <div className={s.banner__inner}>
        <h2 className={s.banner__title}>Test assignment for front-end developer</h2>
        <p className={s.banner__descr}>
          What defines a good front-end developer is one that has skilled knowledge of
          HTML, CSS, JS with a vast understanding of User design thinking as they will be
